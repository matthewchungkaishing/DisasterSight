...
def render_sidebar_extras() -> str:
    ...
    st.sidebar.markdown(
        '<div class="ds-sidebar-section-label">Navigation</div>'
        '<div class="ds-sidebar-section-sub">Analysis Controls</div>',
        unsafe_allow_html=True,
    )

    st.sidebar.markdown("---")
    st.sidebar.markdown('<div class="ds-sidebar-section-label ds-scene-field">Current scene</div>', unsafe_allow_html=True)
    ...
    st.sidebar.markdown(f'<span class="ds-scene-id">{selected}</span>', unsafe_allow_html=True)

    st.sidebar.markdown('<div class="ds-sidebar-section-label">Damage legend</div>', unsafe_allow_html=True)
    legend_html = ""
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown(
        "[📄 Documentation](https://github.com/matthewchungkaishing/DisasterSight)  \n"
        "[💬 Support](https://github.com/matthewchungkaishing/DisasterSight/issues)",
    )
